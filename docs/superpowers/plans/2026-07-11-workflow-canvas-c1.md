...
- [ ] **Step 1: 写失败测试（GraphValidatorTest 追加）**
...
- [ ] **Step 3: 实现 validateBasics 并让 validateAndOrder 复用**
...
- [ ] **Step 5: 写失败测试（WorkflowDraftServiceTest 调整）**
...
- [ ] **Step 2: 跑集成测试（需 Docker，普通沙箱失败则提权）**
