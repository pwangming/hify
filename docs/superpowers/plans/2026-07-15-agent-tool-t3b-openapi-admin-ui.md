...
- [x] **Step 1：写失败测试（加进 ToolAdminServiceTest）**
...
- [x] **Step 3：去掉 AuthHeaderInput.value 的 @NotBlank**
...
- [x] **Step 4：ToolAdminService 拆 buildSpec**
...
- [x] **Step 1：写失败测试（追加到 ToolList.spec.ts）**
...
- [x] **Step 3：改写 ToolList.vue（在 Task 3 基础上加抽屉与表单逻辑）**
